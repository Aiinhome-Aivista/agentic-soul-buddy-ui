    ...
    const sections = [
        {
            ...
            content: "By accessing and using Cosmic Wisdom, you accept and agree to be bound by these Terms of Use. If you do not agree to these terms, please do not use our service. Your continued use of the platform constitutes acceptance of any updates to these terms."
        },
        {
            icon: "license",
            title: "Use License",
            content: "We grant you a personal, non-transferable, non-exclusive license to use Cosmic Wisdom for your personal spiritual growth. You may not modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, or sell any content or software obtained from our service."
        },
        {
            icon: "account_circle",
            title: "User Account",
        ...
        },
        {
            icon: "edit",
            title: "User Content",
            content: "You retain ownership of any content you create within Cosmic Wisdom. By posting content, you grant us a license to use, store, and display that content solely for the purpose of providing our services to you. We will never share your personal reflections or journal entries with third parties."
        },
        {
            icon: "block",
        ...
        },
        {
            ...
            content: "All content, features, and functionality of Cosmic Wisdom, including but not limited to text, graphics, logos, and software, are the exclusive property of Cosmic Wisdom Inc. and are protected by copyright, trademark, and other intellectual property laws."
        },
        {
            icon: "cancel",
            title: "Termination",
        ...
        },
        {
            ...
            content: "Cosmic Wisdom and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use the service. Our total liability shall not exceed the amount you paid for the service in the past 12 months."
        },
        {
            icon: "info",
            title: "Disclaimer",
            content: "Our service is provided 'as is' without warranties of any kind, either express or implied. We do not guarantee that the service will be uninterrupted, secure, or error-free. Cosmic Wisdom is not a substitute for professional mental health care or medical advice."
        },
        {
            icon: "balance",
            title: "Governing Law",
        ...
        },
        {
            ...
            content: "If you have any questions about these Terms of Use, please contact us at legal@cosmicwisdom.com. We are committed to addressing your concerns and ensuring a positive experience with our service."
        }
    ];
            ...
            <section className="relative py-20 px-6 md:px-12 overflow-hidden">
                ...
                <div className="max-w-[900px] mx-auto text-center relative z-10">
                    ...
                    <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
                        Please read these terms carefully before using Cosmic Wisdom. They outline your rights and responsibilities as a member of our community.
                    </p>
