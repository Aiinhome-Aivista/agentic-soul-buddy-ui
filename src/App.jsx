...
import ScrollToTop from "./common/helper/ScrollToTop";

const App = () => (
  <PrimeReactProvider>
    <div className="overflow-y-auto bg-black/50" style={{ width: '100%', minHeight: '100vh', position: 'relative', padding: 0, margin: 0 }}>
      <ContextProvider>
        <div
