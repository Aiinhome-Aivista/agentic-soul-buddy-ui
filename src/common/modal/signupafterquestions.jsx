...
export default function SignupModal2({ OnClose }) {
    ...
    return (
        <div className="fixed inset-0 flex flex-col items-center justify-center gap-[2%] bg-black/10 backdrop-blur-sm animate-fadeIn z-5">
            ...
            <div
                className={
                    `glass-card flex justify-between items-center w-[25%] rounded-2xl p-2 mt-4
           transition-opacity duration-300 ease-in-out
           ${bannerVisible && firstError ? 'opacity-100' : 'opacity-0 pointer-events-none'}`
                }
            >
                <div className="flex gap-2 h-full items-center">
                    <WarningRoundedIcon sx={{ color: "rgba(255, 255, 255, 0.4)", fontSize: '1.2rem' }} />
                ...
                <CloseRoundedIcon
                    ...
                    sx={{ backgroundColor: "rgba(255, 255, 255, 0.1)", borderRadius: '50%', fontSize: '1rem', color: 'white' }}
